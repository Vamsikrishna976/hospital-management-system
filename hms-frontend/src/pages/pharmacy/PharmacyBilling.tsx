...
export default function PharmacyBilling() {
  ...
  const downloadPDF = (billId: string) => {
    window.open(`http://localhost:5000/api/pharmacy/pdf/${billId}`, "_blank");
  };
                ...
                <tr key={bill.id} className="border-b">
                  ...
                  <td className="flex justify-center gap-2">
                    <button
                      onClick={() =>
                        window.open(
                          `http://localhost:5000/api/pharmacy/pdf/${bill.id}/download`,
                          "_blank",
                        )
                      }
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          `http://localhost:5000/api/pharmacy/pdf/${bill.id}`,
                          "_blank",
                        )
                      }
